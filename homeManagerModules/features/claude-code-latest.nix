...
let 
  ...
  claude-code-latest = 
    let
      ...
      registryHash = "sha256-3MNQ+IkPeL7vVB++GJOgIsXkmdhtK2oWAlhY4PgF4Ds=";
      sourceHash = "sha256-pN74V0cFmNjlkTp6qmoOa9z15BhTyM3U6VMi8pTiKcA=";
      depsHash = "sha256-Obe8zW9Z8nXvgeeG6npHTSimo2zY2AXL+fEdzBzjqqY=";
